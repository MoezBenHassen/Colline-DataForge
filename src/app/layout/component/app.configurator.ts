    ...
    getPresetExt() {
        ...
        if (color.name === 'noir') {
            return {
                semantic: {
                    primary: {
                        50: '{surface.50}', 100: '{surface.100}', 200: '{surface.200}', 300: '{surface.300}', 400: '{surface.400}', 500: '{surface.500}',
                        600: '{surface.600}', 700: '{surface.700}', 800: '{surface.800}', 900: '{surface.900}', 950: '{surface.950}'
                    },
                    colorScheme: {
                        light: {
        ...
        // --- START OF FIX ---
            ...
            return {
                semantic: {
                    ...
                    colorScheme: {
                        light: lightScheme,
                        dark: lightScheme // Force dark mode to use the exact same values as light mode
                    }
                }
            };
        }
                    ...
                    semantic: {
                        ...
                        colorScheme: {
                            ...
                            dark: {
                                ...
                                highlight: { background: 'color-mix(in srgb, {primary.400}, transparent 84%)', focusBackground: 'color-mix(in srgb, {primary.400}, transparent 76%)',
